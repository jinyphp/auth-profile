...
class ProfilePhone extends Component
{
    ...
    public function mount()
    {
        ...
        $this->actions['nested']['view_table'] = 'jiny-profile::livewire.phone.table';
        $this->actions['nested']['view_list'] = 'jiny-profile::livewire.phone.list';
        $this->actions['nested']['view_form'] = 'jiny-profile::livewire.phone.form';
